...
import GameCell from "@/app/components/game_cell";
import GameDialog from "@/app/components/game_dialog";
...
export default function PSNPage() {
    ...
    return (
        <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 font-mono dark:bg-black p-10">
            <h1 className={`scroll-m-20 text-4xl font-semibold tracking-tight text-balance`}>PSN Tracking</h1>
            <br />
